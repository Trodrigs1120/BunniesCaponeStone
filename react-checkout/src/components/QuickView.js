      ...
      <div className={this.props.openModal ? "modal-wrapper active" : "modal-wrapper"}>
        <div className="modal" ref="modal">
          ...
          <div className="quick-view">
            <div className="quick-view-imgurl"><img src={this.props.product.imgurl} alt={this.props.product.name}/></div>
            <div className="quick-view-details">
              <span className="product-name">{this.props.product.name}</span>
              <span className="product-price">{this.props.product.price}</span>
              <span className="product-weight">{this.props.product.weight}</span>
              <span className="product-contains">{this.props.product.contains}</span>
            </div>
          </div> 
        </div>
      </div>
